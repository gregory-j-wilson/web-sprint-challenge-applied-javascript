...
1. What is the DOM?
    ...
    Dom is a tree-like structure (Document Object Model) that is created by the html of a website, including all its elements. It can be modified with Javascript.

2. What is an event?

    It's when something happens - like the user clicks, or presses a key.

3. What is an event listener?

    It listens for when an event like a click occurs, and then makes something happen when that event occurs.
...
5. What is a component?
    ...
    A component is a function that generates a piece of UI based on some data, maybe from an API.
